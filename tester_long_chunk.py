...
import numpy as np
from data_loader import  get_audio_loader_full
import datetime
from sklearn import metrics
import time
from models import HPCPModelv2, NoisyHPCPModelv2, SingleModel
import argparse
...
def test(model_mode):
    ...
    # load dataset
    test_dl = get_audio_loader_full(root="E://mtg-jamendo-melspec-10//",
                                    subset="moodtheme",
                                    batch_size=64,
                                    tr_val='test', 
                                    split=0,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", type=str, required=True,
                        help="long chunk model type. choose among 'normal', 'hpcp', 'hpcp-noisy'")
